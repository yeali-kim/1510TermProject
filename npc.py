def jinkx():
    responses = {
        "greeting": "Hi there little fella! I can teach you some magic spells. Would you like to learn some? (Y/N)",
        "yes_response": "I knew it! Let's begin. Avada Kedavra!",
        "no_response": "Fine. I didn't see a great wizard in you anyways."
    }
    
def chrissipus():
    responses = {
        "greeting": "Hello there, tiny being! I can teach you some sword fighting skills. Would you like to learn some? (Y/N)",
        "yes_response": "I knew it! Grab your sword my friend! Not that one. That one is expensive.",
        "no_response": "Fine. You don't look that strong anyways."
    }
    
def hypatia():
    responses = {
        "greeting": "Greetings, traveler! I can teach you some archery skills. Would you like to learn some? (Y/N)",
        "yes_response": "I knew it! I will make you the best archer in the world.",
        "no_response": "Fine. You look clumsy anyways. Archery is not for everyone."
    }
